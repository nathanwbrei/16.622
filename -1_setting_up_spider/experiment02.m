...
% preliminary data via a vanilla SVM. 
%
% 16.62x Project
% Partner: Bo Han
% Advisor: Moe Win
...
disp '--------------------------------------------'
disp ' '
disp ' Experiment 2: Distinguishing LOS from NLOS'
disp ' '
disp '--------------------------------------------'
disp ' '
...
[X1,Y1,Z1]=select(alldata,selectLOS,3);
[X2,Y2,Z2]=select(alldata,selectMetal,3);
