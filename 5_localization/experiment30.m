% % % % % % % % % % % % % % % % % % % % % % % % %
%
% Experiment script #29: Histograms of feature space--location, const env
% by Nathan Brei
% n_brei@mit.edu
%
% 16.62x Project
...
disp '--------------------------------------------'
disp ' '
disp ' Experiment 30: Histograms of feature space: LOCATION, const env'
disp ' '
disp '--------------------------------------------'
disp ' '
...
selectFcn{2} = @(sample) (sample.env==1 && sample.bar == 1);
selectFcn{3} = @(sample) (sample.env==1 && sample.bar == 6);
selectFcn{4} = @(sample) (sample.env==1 && sample.bar == 11);
